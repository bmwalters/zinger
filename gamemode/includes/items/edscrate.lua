...
function ITEM:Activate()
	...
	-- make sure it is in a playable area
	...
	for _, enemy in pairs(team.GetPlayers(util.OtherTeam(t))) do
		...
		if IsBall(ball) and (tr.HitPos - ball:GetPos()):Length() < 180 then
	...
	crate.Ignore = t
	crate.DoPickup = function(me, ply, ball)
		if ply:Team() ~= me.Ignore then
	...
	-- give them a tip that it is not real
